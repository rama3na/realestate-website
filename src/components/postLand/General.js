...
function General() {
    ...
    let addLandData=(data1)=>{
        ...
        fd.append("details",JSON.stringify(data1))

        fd.append("photo1",selectFile)

        axios.post("http://localhost:3500/land-api/land-register",fd)
        .then(response=>{
  ...
  return (
    <div >
        ...
        <div className="row">
            <div className="col-sm-8 col-xl-10 col-md-6 mx-auto border  border-shadow px-4 py-4">
                <form onSubmit={handleSubmit(addLandData)}>
                    ...
                    <div className="transaction">
                        ...
                        <select name="UOM" id="UOM" defaultValue='select...' >
